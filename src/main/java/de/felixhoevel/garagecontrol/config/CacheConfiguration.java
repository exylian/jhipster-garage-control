...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.felixhoevel.garagecontrol.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.felixhoevel.garagecontrol.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, de.felixhoevel.garagecontrol.domain.User.class.getName());
            createCache(cm, de.felixhoevel.garagecontrol.domain.Authority.class.getName());
